	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.html">	<h2> Hospital "Obispo Indaburo"</h2><h2>Doctor Login</h2></a>
				</div>

				<div class="box-login">
				<div class="botones-login">
								<a href="../login.php"><button class="batman btn btn-success" name="submit">Pacientes</button></a>
								<a href="../doctor/index.php"><button class="batman btn btn-success" name="submit">Doctores</button></a>
