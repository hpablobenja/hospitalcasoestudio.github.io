...
<html lang="en">
	<head>
		<title>Paciente  | Reservas citas</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Paciente | Reserva Citas Medicas</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Paciente</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Reserva Medica</h5>
												</div>
...
<div class="form-group">
						...
						<option value="">Lucas Perez</option>
						<option value="">Pedro Sanchez</option>
						</select>
														</div>
